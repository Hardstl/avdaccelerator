...
var varAvdWrklKvPrivateEndpointName = 'kv-avd-${varDeploymentPrefixLowercase}-${varAvdNamingUniqueStringSixChar}-vault-pe'
...
var varAvdWrklStoragePrivateEndpointName = 'stavd${varDeploymentPrefixLowercase}${varAvdNamingUniqueStringSixChar}-file-pe'
